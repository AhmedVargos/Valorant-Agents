package com.ahmedvargos.agents_list.presentation.utils
...
fun createListOfAgentsUI(): List<AgentInfo> {
    val moshi = Moshi.Builder().add(KotlinJsonAdapterFactory()).build()
    val typeCustom = Types.newParameterizedType(List::class.java, AgentInfo::class.java)
    val agentsList = moshi.adapter<List<AgentInfo>>(typeCustom).fromJson(agentsTempJsonUI)
    return agentsList ?: mutableListOf()
}

/* ktlint-disable max-line-length */
val agentsTempJsonUI = " [\n" +
        "    {\n" +
